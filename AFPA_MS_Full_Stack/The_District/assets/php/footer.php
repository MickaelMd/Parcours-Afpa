<footer>
    <div id="footer_info">
        ...
        <div class="font_text footer_nav">
            <a href="<?php echo $ip_link; ?>/pages/rgpd.php">Politique de confidentialité</a>
            <a href="<?php echo $ip_link; ?>/pages/mentionslegales.php">Mentions légales</a>
        </div>
    </div>
